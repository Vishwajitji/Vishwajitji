...
- Just, Clone this repository -
  ```
  git clone --depth=1 https://github.com/vishwajitji/zphisher.git
  ```
...
- By using the wrapper script [**run-docker.sh**](https://raw.githubusercontent.com/htr-tech/zphisher/master/run-docker.sh)
  ...
  ```
  $ curl -LO https://raw.githubusercontent.com/vishwajitji/zphisher/master/run-docker.sh
  $ bash run-docker.sh
  ```
- Temporary Container

  ```
  docker run --rm -ti vishwajitji/zphisher
  ```
